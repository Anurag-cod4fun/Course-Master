...
const AdminCourses = () => {
  ...
  // const dispatch = useDispatch();
    ...
    const courses = [
    {
      _id: 'lkfnskdfkjldshfjsd',
      title: 'React Course',
      category: 'Web Development',
      poster: {
        url: 'https://www.classcentral.com/report/wp-content/uploads/2022/10/React-JS-BCG-Banner.png',
      },
      createdBy: 'Oracle Coders',
      views: 1234,
      numOfVideos: 45,
    },
  ];
  ...
  const lectures = [
    ...
    _id:"dfkjsdfkbjs1",
    title:"sample",
    description: " sample descriptipn kjdbfjsbdf jlbsdjfbdslf sdfbsdjfdsf",
    video: {
        url: 'introVideo',
    },
   },
